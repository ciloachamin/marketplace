      ...
      <MaxWidthWrapper className='px-2.5 md:px-20'>
            ...
            <div>
              <div className='relative flex items-center px-6 py-6 sm:py-8 lg:mt-0'>
                ...
                <div className='text-center relative mx-auto max-w-sm'>
                  <h2 className='font-semibold text-zinc-800'> {/* Color de texto más oscuro para mejorar contraste */}
                    Conviértete en vendedor
                  </h2>
                  <p className='mt-2 text-sm text-zinc-600'> {/* Ajuste del color de texto */}
                    Si deseas vender productos de alta calidad,
                    puedes hacerlo en cuestión de minutos.{' '}
                    <Link
                      href='/seller-plan'
                      aria-label="Comienza ahora"
                      className='whitespace-nowrap font-medium hover:text-zinc-900'> {/* Ajuste del color de texto hover */}
                      Comienza ahora &rarr;
                    </Link>
                  </p>
                </div>
        ...
        <div className='text-center md:text-left'>
          <ul className="flex justify-center mt-5 space-x-5">
            ...
            <li>
              <a href="https://www.tiktok.com/@espeshopp" aria-label='tiktok' className="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
