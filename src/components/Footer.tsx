      ...
      <MaxWidthWrapper className='px-2.5 md:px-20'>
        ...
        <div className='text-center md:text-left'>
          <ul className="flex justify-center mt-5 space-x-5">
            <li>
              <a href="https://www.facebook.com/smartuc32" className="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
            ...
            <li>
              <a href="https://www.tiktok.com/@espeshopp" className="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
