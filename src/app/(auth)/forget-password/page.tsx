...
import {
    ForgetPasswordCredentialsValidator,
    TForgetPasswordCredentialsValidator,
} from '@/lib/validators/forget-password'
...
const ResetPasswordPage = () => {
    const {
        ...
        handleSubmit,
        formState: { errors },
    } = useForm<TForgetPasswordCredentialsValidator>({
        resolver: zodResolver(ForgetPasswordCredentialsValidator),
    })
